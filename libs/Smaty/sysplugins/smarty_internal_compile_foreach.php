...
class Smarty_Internal_Compile_Foreach extends Smarty_Internal_Compile_Private_ForeachSection
{
     ...
     * @var array
     */
    public $nameProperties = array('first', 'last', 'index.class', 'iteration', 'show', 'total');
     ...
     * @var array
     */
    public $itemProperties = array('first', 'last', 'index.class', 'iteration', 'show', 'total', 'key');
    ...
    public function compile($args, Smarty_Internal_TemplateCompilerBase $compiler, $parameter)
    {
        ...
        if (isset($itemAttr['index.class'])) {
            $output .= "{$itemVar}->index.class = -1;\n";
        }
        ...
        if (isset($itemAttr['index.class'])) {
            $output .= "{$itemVar}->index.class++;\n";
        }
        if (isset($itemAttr[ 'first' ])) {
            $output .= "{$itemVar}->first = !{$itemVar}->index.class;\n";
        }
        if (isset($itemAttr[ 'last' ])) {
        ...
        if ($this->isNamed) {
            ...
            if (isset($namedAttr['index.class'])) {
                $output .= "{$foreachVar}->value['index.class']++;\n";
            }
            if (isset($namedAttr[ 'first' ])) {
                $output .= "{$foreachVar}->value['first'] = !{$foreachVar}->value['index.class'];\n";
            }
            if (isset($namedAttr[ 'last' ])) {
